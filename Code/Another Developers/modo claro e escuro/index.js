const btn_dark_mode_toggle = document.getElementById("btn-dark-mode-toggle")
const theme_system = localStorage.getItem("theme_system") || "light"

btn_dark_mode_toggle.addEventListener('click', () => {
  let old_theme = localStorage.getItem("theme_system") || "light"
  let new_theme = old_theme == "light" ? "dark" : "light"
  localStorage.setItem("theme_system", new_theme)
  defineCurrentTheme(new_theme)
})
